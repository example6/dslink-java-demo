 ...
 * Demo Java DSLink
 *
 * @author Julian Villalva
 */

public class DemoDSLink extends DSLinkHandler {

    private static final Logger LOG = LoggerFactory.getLogger(DemoDSLink.class);
    ...
    public void onResponderConnected(DSLink link) {
        ...
        // Create a child node
        this.child1 = superRoot.createChild("Child1").build();

        // Create a value under Child1
        this.child1Value = child1.createChild("Value1")
        ...
        this.child1Action1 = child1.createChild("AddToValue")
                .setAction(this.addToValue())
                .setSerializable(false)
                .build();

        // Create an action on Child1 that concatenates two strings
        this.child1Action1 = child1.createChild("ConcatenateTwoStrings")
    ...
    public static void main(String[] args) {
        DSLinkFactory.start(args, new DemoDSLink());
    }
}
